...
const Login: Component = () => {
  ...
  let formVal;
  formGroup: formGroup
  // We create our form group definition using `createFormGroup` and pass to it a desired
  // structure for our form group
  ...
  // Here we can access various form control properties as SolidJS signals
  // We can e.g. access form values with `value` property
  const [form, setForm] = fg.value;

  // Accessing `valid` reactive form control property showing
  // whether the form control value is valid or not
  const valid = fg.valid;

  // Accessing `valueAll` reactive form group property showing
  //  whether the entire form group is valid
  const validAll = fg.validAll;

  // Accessing `touched` reactive property showing
  // whether the "blur" event was triggered on the form control
  const [touched] = fg.touched;
              ...
              <form use:formGroup={fg}>
                ...
                <div class="mb-6">
                  <input formControlName="username"
                    type="text"
                    class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Email address" />
                </div>
                ...
                <div class="flex justify-between items-center mb-6">
                  <div class="form-group form-check">
                    <input
                      type="checkbox" formControlName="acceptTerms"
